...
export const DATA = {
  aboutMe:
    'AWS Certified | Full-stack developer skilled in seamless user experiences, efficient backend systems, & cloud integration. Proficient in React & Node.js. Delivering solutions that drive growth & elevate platforms.',
  welcomeMsg: 'Tamik Loh',
  roles: [
  ...
  education: [
    {
      ...
      endDate: 'April 2019',
      description:
        'Specialized in computer science and mathematics, focusing on software engineering, algorithms, and data structures.',
    },
    {
      ...
      endDate: 'April 2019',
      description:
        'Completed an intensive bootcamp specializing in the MERN stack, developing multiple end-to-end projects showcasing proficiency in OOP principles.',
    },
  ],
  skills: {
    frontEnd: {
  ...
  randoms: [
    {
      description:
        'Medium Article about Monorepo architecture and how Lerna helped us. It covers the benefits of using Lerna for managing multiple packages within a single repository, including improved code sharing, versioning, and dependency management.',
    ...
    {
      description:
        'Designed a reusable template for uploading small and large files to AWS S3. The template handles progress bar updates, chunked uploads, and serverless deployment, ensuring scalability and simplicity. Read the full walkthrough in my Medium article!',
    ...
    {
      description:
        'A comprehensive guide to TypeScript tips and tricks, covering advanced features, best practices, and performance optimizations. This guide is designed to help developers enhance their TypeScript skills and write more efficient code.',
    ...
    {
      description:
        'Mentored seven aspiring developers, guiding them from foundational learning to securing professional roles. Helped them gain hands-on experience and build real-world projects.',
      title: 'Mentorship',
      link: '',
    },
    // {
    ...
    {
      description:
        'Completed a framework-agnostic event-handling template for microfrontend architectures, simplifying communication between React, Vue, and Angular using a custom EventBus and other browser APIs. This lightweight, error-resilient approach includes an ErrorBoundary for remote failures. Check out the full implementation in my Medium article!',
    ...
    {
      description:
        'Actively volunteering in Calgary local projects, including CalgaryCrafters and Calgary Projects Free Developers, to collaborate on community-driven software solutions. We meet weekly to develop real-world applications that support local initiatives.',
